...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? "#d43937" : "#af2c2a",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#af2c2a",
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? "#6b6b6b" : "#b3c7f9",
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  sTabBarActiveTextColor: "#d43937",
  tabBarActiveTextColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  tabActiveBgColor: platform === PLATFORM.IOS ? "#cde1f9" : "#af2c2a",

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  toolbarDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#af2c2a",
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? "#CECDD2" : "#fff",
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  toolbarDefaultBorder: platform === PLATFORM.IOS ? "#a7a6ab" : "#af2c2a",
  ...
  listItemSelected: platform === PLATFORM.IOS ? "#d43937" : "#af2c2a",
  ...
  radioSelectedColorAndroid: "#af2c2a",
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? "#F8F8F8" : "#af2c2a",
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  segmentTextColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  segmentActiveTextColor: platform === PLATFORM.IOS ? "#fff" : "#af2c2a",
  segmentBorderColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  segmentBorderColorMain: platform === PLATFORM.IOS ? "#a7a6ab" : "#af2c2a",
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? "#F8F8F8" : "#af2c2a",
  topTabBarTextColor: platform === PLATFORM.IOS ? "#6b6b6b" : "#ff8482",
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
  topTabBarBorderColor: platform === PLATFORM.IOS ? "#ff8482" : "#fff",
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? "#d43937" : "#fff",
